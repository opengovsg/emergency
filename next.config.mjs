...
const ContentSecurityPolicy = `
  ...
  connect-src 'self' https://browser-intake-datadoghq.com https://*.browser-intake-datadoghq.com https://vitals.vercel-insights.com/v1/vitals https://cdn.growthbook.io ${
