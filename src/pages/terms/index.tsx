...
const SectionTitle: FC<ListItemProps> = ({ children }) => (
        ...
        <Container color="secondary.700" maxW="85ch" p="2rem" flex={1}>
          <Stack spacing="5rem">
              ...
              <OrderedList spacing="1.5rem" marginInlineStart="1.5rem">
                  ...
                  <SubSectionOrderedList>
                    ...
                    >
                      ...
                      <b>
                        ...
                        use will constitute your agreement to the Terms of Use
                ...
                <SectionListItem>
                  ...
                  <Text textStyle="body-1">
                    ...
                    and made available only for trial and feedback purposes.
                    None of the Services are for production use and, at
                    GovTech’s sole and absolute discretion, may receive no or
                    limited support. Certain functions may be disabled or
                    simulated. You shall not depend on any of the functions of
                    any of the Services and, without prejudice to GovTech’s
                    other rights, GovTech disclaims all liability arising out of
                ...
                <SectionListItem>
                  ...
                  <SubSectionOrderedList>
                    ...
                    >
                      ...
                      redistribute or sublicense the Service or any part of the
                      Service without the prior written consent of GovTech or
                      the respective third party owners. You also shall not use
                      the Service in violation of any applicable laws or
                      agreements that you have with any third parties. All
                      express or implied rights to the Service not specifically
                ...
                <SectionListItem listStyleType="'3A. '">
                  ...
                  <SubSectionOrderedList>
                    ...
                    >
                      ...
                      identity of the person using the Service. Without
                      prejudice to the foregoing, GovTech is not under any duty
                      to verify that any biometric identifier used with the
                      Service, or on your device, belongs to you.
                    </SubSectionListItem>
                    <SubSectionListItem
                      prependSequenceMarker="3A."
                      isNumericMarker
                    ...
                    >
                      ...
                      data, or communications received from the account or use
                      of the Service in relation to your authentication
                      credentials, as if such instructions, information, data or
                      communications were issued by you, whether or not the same
                    ...
                    >
                      ...
                      unofficial modifications made to your device which permit
                      or escalate privileged access, or remove restrictions to
                      such access, which are not intended by the manufacturer or
                ...
                <SectionListItem listStyleType="'4. '">
                  ...
                  <SubSectionOrderedList>
                    ...
                    >
                      ...
                      {'"'}). GovTech may be required under or as a result of
                      the Third Party Terms to notify you of certain terms that
                      ...
                      platform from which you obtain any part of the Service
                      (e.g. Google Play Store or Apple App Store terms) which
                      bind GovTech as a developer or user of the distribution
                      platform (the {'"'}
                      <b>Distribution Terms</b>
                      {'"'}). Information on the Third Party Terms are embedded
                      in the Service, already accounted for in these Terms of
                      Use, publicly available (e.g the Distribution Terms) or
                      otherwise listed in the Schedule herein. For the avoidance
                      of doubt, insofar as this Clause 4 relates to the
                      Distribution Terms, the relevant Distribution Terms are
                      the terms of the specific platform from which you obtained
                      a copy of the software or application that is part of the
                      Service. For example, if you obtained the said copy from
                      the Google Play Store, then the relevant terms are
                    ...
                    >
                      ...
                      required to notify you, and you unconditionally agree to
                      be bound by all the obligations in the Third Party Terms
                      which are applicable to you as the end user. For the
                      avoidance of doubt, where Third Party Terms are listed,
                      such Third Party Terms shall be deemed to include any
                      privacy policies and acceptable use policies as are
                      applicable to you.
                    </SubSectionListItem>
                    <SubSectionListItem
                      prependSequenceMarker="4."
                    ...
                    >
                      ...
                      be deemed to be so altered but only to the extent
                    ...
                    >
                      ...
                      as Incorporated Terms, and you hereby agree to grant such
                      Third Party, such direct rights of enforcement against
                      you.
                    </SubSectionListItem>
                    <SubSectionListItem
                      prependSequenceMarker="4."
                    ...
                    >
                      ...
                      GovTech shall not be responsible for your use of any
                      software or service of a Third Party.
                    </SubSectionListItem>
                  </SubSectionOrderedList>
                </SectionListItem>
                <SectionListItem listStyleType="'5. '">
                  ...
                  <Text textStyle="body-1">
                    ...
                    with the Service. Please also see clause 8 (Privacy Policy).
                    Your use of the Service shall constitute your consent to the
                    access by the Service of such functions of your device as
                ...
                <SectionListItem listStyleType="'5B. '">
                  ...
                  <SubSectionOrderedList>
                    ...
                    >
                      ...
                      GovTech or a Third Party which is designated confidential
                      or proprietary or is otherwise reasonably understood to be
                      confidential or proprietary (collectively, {'"'}
                      <b>Confidential Information</b>
                      {'"'}), you shall not use, disclose or reproduce the
                      Confidential Information except for the purpose for which
                      it was provided to you. If consent to disclose the
                      Confidential Information to a third party is given by
                      GovTech or the Third Party to you, any act or omission in
                      respect of the Confidential Information by that person
                      shall be deemed to be your act or omission and you agree
                      to be fully liable for the same. In all cases, you shall
                    ...
                    >
                      ...
                      <Text mt="1.5rem">
                        you shall immediately notify GovTech or the Third Party
                        of the same and cooperate with GovTech or the Third
                  ...
                  <SubSectionOrderedList>
                    ...
                    >
                      <b>
                        ...
                        relation to the Service and hereby disclaims all
                        express, implied and/or statutory warranties of any kind
                        to you or any third party, whether arising from usage or
                        custom or trade or by operation of law or otherwise,
                    ...
                    >
                      <b>
                        ...
                        party for any damage or loss of any kind whatsoever and
                        howsoever caused, including but not limited to any
                        direct or indirect, special or consequential damages,
                        loss of income, revenue or profits, lost or damaged
                        data, or damage to your computer, software or any other
                    ...
                    >
                      <b>
                        ...
                        products, software, materials and/or services (including
                        without limitation any representation or warranties as
                        to timeliness, reliability, availability,
                        interoperability, quality, fitness for purpose,
                    ...
                    <SubSectionListItem
                      ...
                      isNumericMarker
                    >
                      Without prejudice and in addition to GovTech’s other
                      rights herein:
                      <SubSubSectionOrderedList mt="1.5rem">
                        <SubSectionListItem
                          prependSequenceMarker="6."
                        ...
                        >
                          ...
                          Use to you exceed the amount of fees or payment
                          received by GovTech (and not paid or given to any
                          Third Party by GovTech) from you for the Service in
                          the 12 months preceding the date of the first cause of
                          action; and
                        </SubSectionListItem>
                        <SubSectionListItem
                          prependSequenceMarker="6."
                          isNumericMarker
                        >
                          no action may be brought by you against GovTech
                          arising out of or in connection with these Terms of
                          Use more than one (1) year after the cause of action
                          arose.
                        </SubSectionListItem>
                      </SubSubSectionOrderedList>
                    </SubSectionListItem>
                ...
                <SectionListItem listStyleType="'7. '">
                  ...
                  <SubSectionOrderedList>
                    ...
                    >
                      ...
                      not maintained or controlled by GovTech, GovTech shall not
                      be responsible for the content of the hyperlinked material
                      and shall not be liable for any damages or loss arising
                      from access to the hyperlinked material. Use of the
                      hyperlinks and access to such hyperlinked materials are
                      entirely at your own risk. The hyperlinks are provided
                      merely as a convenience to you and do not imply
                      endorsement by, association or affiliation with GovTech of
                    ...
                    <SubSectionListItem
                      ...
                      isNumericMarker
                    >
                      Caching and hyperlinking to, and the framing of, any part
                      of the Service is prohibited save where you have obtained
                      GovTech’s prior written consent. Such consent may be
                      subject to any conditions as may be determined by GovTech
                      in its sole discretion. If you hyperlink to or frame any
                      part of the Service, that shall constitute your acceptance
                      of these Terms of Use and all amendments thereto. If you
                      do not accept these Terms of Use as may be amended from
                      time to time, you must immediately discontinue linking to
                      or framing of any part of the Service.
                    </SubSectionListItem>
                    <SubSectionListItem
                      prependSequenceMarker="7."
                      isNumericMarker
                ...
                <SectionListItem listStyleType="'9. '">
                  ...
                  <Text textStyle="body-1">
                    Subject to the rights of the Third Party, a person who is
                    not a party to this Terms of Use shall have no right under
                    the Contract (Rights of Third Parties) Act or otherwise to
                ...
                <SectionListItem listStyleType="'10. '">
                  ...
                  <SubSectionOrderedList>
                    ...
                    >
                      ...
                      reference to you. Your acceptance of this Terms of Use
                      shall also constitute your consent to such assignment,
                      novation, transfer or sub-contract.
                    </SubSectionListItem>
                  </SubSectionOrderedList>
                </SectionListItem>
                <SectionListItem listStyleType="'10A. '">
                  ...
                  <Text textStyle="body-1">
                    ...
                    but, to the extent permissible, such invalid or
                    unenforceable terms shall be deemed to have been replaced by
                    terms that are (a) valid and enforceable and (b) express the
                    intention or produce the result closest to the original
                    intention of the invalid or unenforceable terms.
                  </Text>
                </SectionListItem>
                <SectionListItem listStyleType="'11. '">
                  ...
                  <SubSectionOrderedList>
                    ...
                    >
                      ...
                      Centre ({'"'}
                      <b>SIAC</b>
                      {'"'}) in Singapore in accordance with the Arbitration
                      Rules of the SIAC ({'"'}
                      <b>SIAC Rules</b>
                      ...
                      <Text mt="1.5rem">
                        Where GovTech is the defendant or respondent, it shall
                        be given at least 30 days before the commencement of any
                        legal action against it to elect to exercise the right
                        herein to have the dispute submitted to arbitration.
                        This right to elect shall not prejudice GovTech’s right
                        to a limitation defence and the period to exercise the
                        right shall not be abridged by reason of any accrual of
                        a limitation defence in favour of GovTech during the
                        said period.
                      </Text>
                    </SubSectionListItem>
                  </SubSectionOrderedList>
            ...
            <Box as="section">
              ...
              <OrderedList spacing="1.5rem" marginInlineStart="1.5rem">
                <SectionListItem>
                  <SectionTitle>Name of Service: eNotes</SectionTitle>
                </SectionListItem>
                <SectionListItem>
                  <SectionTitle>Nature of Service</SectionTitle>
                  <SubSectionOrderedList>
                    <Text textStyle="body-1" mb="1.5rem" ml="-1.5rem">
                      This Service facilitates the creating of eNotes
                    </Text>
                    <SubSectionListItem>
                      GovTech is NOT responsible for the fulfilment and quality
                      of eNotes.
                    </SubSectionListItem>
                  </SubSectionOrderedList>
                </SectionListItem>
